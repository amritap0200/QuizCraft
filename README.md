...
1. **User**: Stores user information, credentials, and profile stats
2. **Quiz**: Stores quiz data including questions, options, and settings
3. **QuizAttempt**: Tracks user quiz attempts, answers, and scores
...
2. **JWT Authentication Error**: Check JWT secret in .env file
3. **CORS Errors**: Verify CLIENT_URL in backend .env file
